...
const socials = [
  ...
  {
    label: "Email",
    href: "mailto:hello@ampmemonight.com",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
export default function Footer() {
  return (
    <footer className="w-full bg-black border-t border-white/10 pt-10 pb-36 px-6 text-center">
